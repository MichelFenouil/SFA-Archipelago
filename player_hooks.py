...
async def _toggle_babies_quest(ctx: "SFAContext", zone_name: str) -> None:
    if zone_name != "CRF_QUEEN_ENTRANCE":
        return
...
def register_default_special_hooks(ctx: "SFAContext") -> None:
    ...
    ctx.hooks.add_player_coord_transition(_toggle_babies_quest, "enter")
    ctx.hooks.add_player_coord_transition(_toggle_babies_quest, "leave")
    ctx.hooks.add_player_coord_zone(
