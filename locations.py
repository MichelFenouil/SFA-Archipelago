...
class SFALocation(Location):
    """Location class for Star Fox Adventure."""
...
class SFALocationData:
    """Data class for locations in Star Fox Adventure."""
...
def locations_name_to_id_dict() -> dict[str, int]:
    """Name to id dict for Star Fox Adventure locations."""
...
LOCATION_SHOP: dict[str, SFAShopLocationData] = {
    ...
    "Buy Hi-Tech Display Device": SFAShopLocationData(
        201, 0x035E, T2_ADDRESS, SFALocationType.SHOP, SFARegion.SH, 201, 20
    ),
    ...
    "Buy Map CloudRunner Fortress": SFAShopLocationData(
        218, 0x0835, T2_ADDRESS, SFALocationType.MAP, SFARegion.SH, 0, 5
    ),
    ...
    "Buy Map Volcano Force Point": SFAShopLocationData(
        221, 0x0832, T2_ADDRESS, SFALocationType.MAP, SFARegion.SH, 0, 10
    ),
}
...
LOCATION_FUEL_CELL: dict[str, SFALocationData] = {
    ...
    "SW Transition Booster Left": SFALocationData(
        122, 0x095F, T2_ADDRESS, SFALocationType.FUELCELL, SFARegion.SH_SW_TRANSITION
    ),
    "SW Transition Booster Right": SFALocationData(
        123, 0x0960, T2_ADDRESS, SFALocationType.FUELCELL, SFARegion.SH_SW_TRANSITION
    ),
}
